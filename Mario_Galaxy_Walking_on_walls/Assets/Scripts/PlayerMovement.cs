...
public class PlayerMovement : MonoBehaviour
{
    ...
    private CameraFollow CameraFol;

    private DetectCollision Collision;
    [HideInInspector]
    ...
    void Awake()
    {
        ...
        Collision = GetComponent<DetectCollision>();
        GroundDir = transform.up;
        SetGrounded();
        
        Camera = GameObject.FindGameObjectWithTag("MainCamera").transform;
        CameraY = Camera.transform.parent.parent.transform;
        CameraFol = Camera.GetComponentInParent<CameraFollow>();
    ...
    void FixedUpdate()  //world movement
    {
        ...
        if (States == WorldState.Grounded)
        {
            ...
            //switch to air
            bool Ground = Collision.CheckGround(-GroundDir);
    ...
    void MoveSelf(float d, float Speed, float Accel)
    {
        ...
        Vector3 screenMovementForward = CameraY.transform.forward;
        Vector3 screenMovementRight = CameraY.transform.right;
